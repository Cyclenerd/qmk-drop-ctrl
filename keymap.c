...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    [_KL] = LAYOUT(
        ...
        TD(TD_CTRL_TERM),  KC_LGUI, KC_LALT,               KC_SPC,                       KC_RALT, TT(_FL), KC_BTN2,  KC_RCTL,   KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [_FL] = LAYOUT(
        ...
        _______, _______, _______,                   _______,                            _______, TG(_FL), _______, _______,          _______, RGB_VAD, _______
    ),
    [_ML] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          KC_WH_D, TG(_ML), KC_WH_U,
        ...
        _______, _______, _______,                   _______,                            _______, TG(_ML), _______, _______,          KC_ACL0, KC_ACL1, KC_ACL2
    ),
    /*
    [X] = LAYOUT(
...
const uint8_t PROGMEM ledmap[][DRIVER_LED_TOTAL][3] = {
    ...
    [_ML] = {
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          ORANGE,  _______, ORANGE,
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                            _______,
        _______, _______, _______,                   _______,                                     _______, _______,  _______, _______, GREEN,  GREEN,   GREEN
    },
};
